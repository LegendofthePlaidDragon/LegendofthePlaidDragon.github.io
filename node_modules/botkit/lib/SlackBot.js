...
function Slackbot(configuration) {
  ...
  slack_botkit.createHomepageEndpoint = function(webserver) {
    ...
    slack_botkit.log('** Serving app landing page at : http://dunshire-slack.herokuapp.com:' + slack_botkit.config.port + '/');
  ...
  slack_botkit.createWebhookEndpoints = function(webserver) {
    ...
    slack_botkit.log('** Serving webhook endpoints for Slash commands and outgoing webhooks at: http://dunshire-slack.herokuapp.com:' + slack_botkit.config.port + '/slack/receive');
  ...
  slack_botkit.createOauthEndpoints = function(webserver,callback) {
    ...
    slack_botkit.log('** Serving oauth return endpoint: http://dunshire-slack.herokuapp.com:' + slack_botkit.config.port + '/oauth');
